...
export const SideNav = () => {
    ...
    return (
        <nav className="fixed right-8 top-1/2 -translate-y-1/2 z-40 hidden md:flex flex-col gap-6">
            {links.map((link) => {
                ...
                return (
                    ...
                    >
                        ...
                        {/* Diamante — background sólido para tapar a linha atrás */}
                        <div className={`
                        ...
                        `}>
                            <div className={`-rotate-45 transition-colors duration-300 ${isActive ? "text-nordic-gold" : "text-nordic-parchment/50 group-hover:text-nordic-bronze"}`}>
                                {link.icon}
                            </div>
                        </div>
                    </a>
            ...
            {/* Linha de progresso */}
            <div className="absolute top-5 right-[1.2rem] w-px bg-nordic-gold z-0 shadow-[0_0_6px_rgba(212,180,131,0.5)] transition-[height] duration-150"
